...
public class SendCommunalNotification: ISendNotification
{
    ...
    public SendCommunalNotification(string confirmationSmsTemplateId, string confirmationEmailTemplateId,
